...
const useUpdateRecordLifecycle = vi.hoisted(() => vi.fn(() => ({ mutateAsync: vi.fn(), isPending: false })))
...
vi.mock('@/hooks/crm', () => ({ useRecordWindow, useGetFieldChanges, useGetActivity, useGetRelatedRecords: () => ({ isPending: false, isError: false, data: { related: [] } }), useUpdateRecordValue, useUpdateRecordLifecycle, useCreateRecord }))
