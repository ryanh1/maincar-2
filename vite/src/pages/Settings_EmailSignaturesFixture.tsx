...
/** Development-only shell for the MAI-317 browser CRUD journey. */
export function Settings_EmailSignaturesFixture() {
  ...
  return <QueryClientProvider client={client}>
    <BrowserRouter>
      <TooltipProvider>
        <main className="min-h-dvh bg-bg p-6"><Settings_EmailSignaturesTab /></main>
      </TooltipProvider>
    </BrowserRouter>
  </QueryClientProvider>
}
