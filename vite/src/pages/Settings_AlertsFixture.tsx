...
/** Development-only browser shell for the MAI-388 foreground alert journey. */
export function Settings_AlertsFixture() {
  ...
  return <QueryClientProvider client={client}><BrowserRouter><TooltipProvider><main className="min-h-dvh bg-background p-6"><Settings_AlertsTab /></main><Toaster /></TooltipProvider></BrowserRouter></QueryClientProvider>
}
