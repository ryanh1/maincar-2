...
export const queryKeys = {
  ...
  calls: {
    ...
    comments: (orgId: string, callId: string) => ['calls', 'comments', orgId, callId] as const,
  ...
  voicemailDrops: {
    all: (orgId: string) => ['voicemailDrops', orgId] as const,
    list: (orgId: string) => ['voicemailDrops', orgId, 'list'] as const,
  },
  notifications: {
